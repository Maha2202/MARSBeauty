...
public class ConfirmOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        RTHPB = new javax.swing.JLabel();
        COBG = new javax.swing.JLabel();
        ...
        RTHPB.setIcon(new javax.swing.ImageIcon(getClass().getResource("/backgrounds/TabR.png"))); // NOI18N
        RTHPB.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                RTHPBMouseMoved(evt);
            }
        });
        RTHPB.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                RTHPBMouseClicked(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                RTHPBMouseExited(evt);
            }
        });
        jPanel1.add(RTHPB, new org.netbeans.lib.awtextra.AbsoluteConstraints(67, 551, 240, 50));

        COBG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/backgrounds/15-ThankYou.png"))); // NOI18N
        jPanel1.add(COBG, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 375, 667));
    ...
    private void RTHPBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RTHPBMouseClicked
        this.dispose();
        new Home_Page().setVisible(true);
    }//GEN-LAST:event_RTHPBMouseClicked

    private void RTHPBMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RTHPBMouseMoved
        ImageIcon icon = new ImageIcon("icons/TabP.png");
        RTHPB.setIcon(icon);
    }//GEN-LAST:event_RTHPBMouseMoved

    private void RTHPBMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_RTHPBMouseExited
        ImageIcon icon = new ImageIcon("icons/TabR.png");
        RTHPB.setIcon(icon);
    }//GEN-LAST:event_RTHPBMouseExited
    ...
    private javax.swing.JLabel COBG;
    private javax.swing.JLabel LogoutB;
    private javax.swing.JLabel Menu;
    private javax.swing.JLabel RTHPB;
